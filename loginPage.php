...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-success sticky-top">
        <div class="container">
          <a class="navbar-brand" href="#">Selamat Datang di Jurnal harian</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="text-dark navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="index.html#jadwal">Schedule</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.html#gallery">Gallery</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="loginPage.php#Login">Login</a>
                  </li>
            </ul>
          </div>
        </div>
    ...
    <!-- form -->
    <section id="form" class="text-center p-5 bg-light">
    <div class="container">
        <div class="row mb-2">
            <div class="col">
